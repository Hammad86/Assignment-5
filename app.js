...
var studentAge="15";
var studentMessage="Certified Mobile App Development";
alert(studentName);
...
var email="sunnyhammad1998@gmail.com";
...
document.write("Yah! I can write HTML content through JavaScript" + "<hr>" );
...
var birthYear= 1998;
document.write("My birth year is " + birthYear + "<br>" + " data type of my declared variable is number" + "<hr>");
...
var quantity= 5;
document.write( "<b>" + visitorName + "</b>" + " ordered "+ "<b>" + productTitle + "</b>" + "onXYZ clothing store" + "<hr>");
...
var myName,my_name,MYNAME,myname,myNAme1;
// var 1name,/name, my name,var,$name;
...
var nums=document.write("SUm of the two inputs is: " + num1+num2 + "<hr>");

//2. Repeat task1 for subtraction, multiplication, division & modulus. 

var num1=+prompt("enter first number");
var num2=+prompt("enter second number");
var nums=document.write("SUm of the two inputs is: " + num1+num2 + "<br>");
var nums2=document.write("Subtraction of two inputs is: " + num1-num2 + "<br>");
var nums3=document.write("multiplication  of two inputs is: " + num1*num2 + "<br>");
var nums4=document.write("Division of two inputs is: " + num1/num2 + "<br>");
var nums2=document.write("Mudulus of two inputs is: " + num1%num2 + "<br>");
